...
class Settings(BaseSettings):
    ...
    pinata_api_base: HttpUrl = Field(
        default="https://api.pinata.cloud", alias="SS58_PINATA_API_BASE"
    )
    pinata_timeout_seconds: int = Field(default=20, alias="SS58_PINATA_TIMEOUT_SECONDS")
    pinata_gateway_base: HttpUrl = Field(
        default="https://gateway.pinata.cloud/ipfs", alias="SS58_PINATA_GATEWAY_BASE"
    )
    pinata_gateway_token: str | None = Field(
        default=None, alias="SS58_PINATA_GATEWAY_TOKEN"
    )
